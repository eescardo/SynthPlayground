...
export const compileAudioProjectToWasmSubset = (project, options) => {
...
export const compileSchedulerEventsToWasmSubset = (project, projectSpec, events) => {
  const patchById = new Map((project.patches || []).map((patch) => [patch.id, patch]));
