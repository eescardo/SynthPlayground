...
export const TRACK_CANVAS_COLORS = {
  ...
  noteLabel: "#ecf5ff",
  noteSelectedOverlay: "rgba(210, 234, 255, 0.08)",
  noteSelectedBorder: "rgba(212, 236, 255, 0.72)",
  noteSelectedFocusOverlay: "rgba(210, 234, 255, 0.18)",
  noteSelectedFocusBorder: "#f3fbff",
  notePlacementOverlay: "rgba(255, 214, 88, 0.16)",
  notePlacementBorder: "#f7d25a",
  selectionBoundary: "rgba(255, 123, 151, 0.29)",
  selectionSourceIndicator: "rgba(183, 228, 255, 0.68)",
