...
export const BEAT_ZOOM_STEP = 1.12;
...
export const SPEAKER_Y_OFFSET = 9;
export const TRACK_PATCH_CONTROL_Y_OFFSET = 44;
export const TRACK_PATCH_CONTROL_SIZE = 22;
export const MACRO_PANEL_TOGGLE_Y_OFFSET = TRACK_PATCH_CONTROL_Y_OFFSET;
...
export const TRACK_CANVAS_COLORS = {
  ...
  noteLabel: "#ecf5ff",
  noteSelectedOverlay: "rgba(246, 232, 199, 0.08)",
  noteSelectedBorder: "rgba(246, 232, 199, 0.72)",
  noteSelectedFocusOverlay: "rgba(246, 232, 199, 0.18)",
  noteSelectedFocusBorder: "#fff2cf",
  notePlacementOverlay: "rgba(255, 214, 88, 0.16)",
  notePlacementBorder: "#f7d25a",
  selectionBoundary: "rgba(246, 232, 199, 0.34)",
  selectionSourceIndicator: "rgba(246, 232, 199, 0.68)",
  selectionFill: "rgba(246, 232, 199, 0.16)",
  selectionBorder: "rgba(255, 242, 207, 0.9)",
  overlapRange: "rgba(255, 35, 35, 0.52)",
  playhead: "#ff5a7b",
  playheadHoverGlow: "rgba(255, 90, 123, 0.28)",
  playheadFocusGlow: "rgba(255, 90, 123, 0.28)",
  ...
  loopStart: "#6ddb84",
  loopEnd: "#6ddb84",
  loopIntensity1: "#356f47",
  loopIntensity2: "#4da963",
  loopIntensity3: "#6ddb84",
  loopIntensity4: "#82f0a0",
  loopIntensity5: "#a1ffc0",
  loopBracket: "rgba(109, 219, 132, 0.72)",
  loopUnmatched: "#e27a7a",
  loopGhost: "rgba(255, 90, 123, 0.35)",
  loopMarkerText: "#07281e",
  ghostPlacementFill: "#f3bf56",
  ghostPlacementBorder: "rgba(255, 226, 146, 0.92)",
  ghostPlacementLabel: "#fff4d6",
  ghostPlacementBadge: "rgba(250, 214, 100, 0.72)",
  ghostPlacementBadgeText: "#3c2300",
  tabSelectionPreviewBorder: "rgba(240, 249, 255, 0.82)",
  tabSelectionPreviewBadge: "rgba(206, 233, 255, 0.78)",
  tabSelectionPreviewBadgeText: "#0f2438",
