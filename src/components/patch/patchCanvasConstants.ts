...
export const PATCH_COLOR_PROBE_SCOPE_WAVE_REGION = "rgba(10, 18, 28, 0.84)";
export const PATCH_COLOR_PROBE_SCOPE_ENVELOPE_REGION = "rgba(10, 18, 28, 0.78)";
...
export const PATCH_COLOR_FULL_SPECTRUM_GRID_MAJOR = "rgba(231, 243, 255, 0.5)";
export const PATCH_COLOR_FULL_SPECTRUM_GRID_MINOR = "rgba(231, 243, 255, 0.3)";
...
export const PATCH_FULL_SPECTRUM_MIN_IMAGE_WIDTH = 720;
export const PATCH_FULL_SPECTRUM_COLUMN_WIDTH = 2;
export const PATCH_FULL_SPECTRUM_EMPTY_IMAGE_HEIGHT = 320;
export const PATCH_FULL_SPECTRUM_TIME_MARKER_RATIOS = [0, 0.5, 1] as const;
export const PATCH_FULL_SPECTRUM_MINOR_GRID_DASH = [2, 3] as const;
export const PATCH_FULL_SPECTRUM_MAJOR_GRID_LINE_WIDTH = 1;
export const PATCH_FULL_SPECTRUM_MINOR_GRID_LINE_WIDTH = 0.75;
export const PATCH_SPECTRUM_FACE_COMPACT_STREAM_COLUMNS = 240;
export const PATCH_SPECTRUM_FACE_EXPANDED_STREAM_COLUMNS = 320;
export const PATCH_SPECTRUM_FACE_COMPACT_STREAM_HEIGHT = 144;
export const PATCH_SPECTRUM_FACE_EXPANDED_STREAM_HEIGHT = 192;
