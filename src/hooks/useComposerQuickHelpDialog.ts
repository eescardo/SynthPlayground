    ...
    return [
      {
        ...
        entries: [
          ...
          { action: "Pitch Preview (semitone)", shortcut: "- / =" },
          { action: "Pitch Preview (eighth-tone)", shortcut: "_ / +" },
      ...
      },
      {
        ...
        entries: [
          ...
          { action: "Nudge Selection by Measure", shortcut: measureShiftArrowShortcut },
          ...
          { action: "Focus Next Note from Playhead", shortcut: "Tab" },
