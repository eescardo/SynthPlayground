    ...
    () => [
      {
        ...
        entries: [
          ...
          { action: "Move Playhead By Measure", shortcut: "Ctrl+Left / Ctrl+Right" },
      ...
      },
      {
        ...
        entries: [
          ...
          { action: "Selected Note By Measure", shortcut: "Ctrl+Left / Ctrl+Right" },
          { action: "Previous / Next Note", shortcut: "Shift+Left / Shift+Right" },
          { action: "Measure-Relative Note", shortcut: "Ctrl+Shift+Left / Ctrl+Shift+Right" },
