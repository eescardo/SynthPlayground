...
export const brandSproutFaviconSrc = new URL("./brand-sprout-favicon.svg", import.meta.url).toString();
...
export const composerNoteIconSrc = new URL("./composer-note.svg", import.meta.url).toString();
